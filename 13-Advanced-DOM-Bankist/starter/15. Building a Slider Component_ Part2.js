...
const slider = function () {
  ...
  const nextSlide = function () {
    // jika curSlides === maxSlides maka curSlides return curSlides 0
  ...
  const prevSlide = () => {
    // jika curSlides === 0 maka curSlides return curSlides maxSlides - 1
    if (curSlides === 0) {
  ...
  // TODO Building a Slider Component_ Part 2
