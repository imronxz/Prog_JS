...
// HACK SOME METHODS
/*
some: A function that accepts up to three arguments.if there was an any value which is condition (boolean) then the some method will return true/false.
*/
// TODO check if beberapa movements are deposited
...
/*
every: if every element passed the test in our callback function only then the every method will return true.
*/
//TODO check jika semua value pada array movements > 0
const everyDeposited = movements.every(mov => mov > 0);
console.log(everyDeposited); //false
// value pada akun5 > 0
const akun5 = account5.movements.every(mov => mov > 0);
console.log(akun5); //true
